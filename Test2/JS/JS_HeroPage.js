                                    ...
                                    <div name={"name_" + i} key={"key_" + i} className="flexChild" >
                                       <h1 name={"h1name_" + i} key={"h1key_" + i} className="flexChildH1" style={{zIndex: "3"}}>
                                          ...
                                          switch (skill_element.primary_attribute) {
                                             case "str":   return <img className="priAttrImg" src={"MiscImages\\hero_strength.png"}></img>;
                                             case "agi": return <img className="priAttrImg" src={"MiscImages\\hero_agility.png"}></img>;
                                             case "int":  return <img className="priAttrImg" src={"MiscImages\\hero_intelligence.png"}></img>;
